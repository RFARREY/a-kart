 ...
 */
fun SearchView.queryTextChangeEvents(): Observable<SearchViewQueryTextEvent> = RxSearchView.queryTextChangeEvents(this)
 ...
 * *Note:* A value will be emitted immediately on subscribe.
 */
fun SearchView.queryTextChanges(): Observable<CharSequence> = RxSearchView.queryTextChanges(this)
 ...
 */
fun SearchView.query(submit: Boolean): Action1<in CharSequence> = RxSearchView.query(this, submit)
