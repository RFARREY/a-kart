 ...
 */
fun View.attaches(): Observable<Unit> = RxView.attaches(this).map { Unit }
 ...
 * to free this reference.
 */
fun View.attachEvents(): Observable<ViewAttachEvent> = RxView.attachEvents(this)
 ...
 * to free this reference.
 */
fun View.detaches(): Observable<Unit> = RxView.detaches(this).map { Unit }
 ...
 */
fun View.clicks(): Observable<Unit> = RxView.clicks(this).map { Unit }
 ...
 */
fun View.drags(handled: Func1<in DragEvent, Boolean>): Observable<DragEvent> = RxView.drags(this, handled)
 ...
 */
fun View.draws(): Observable<Unit> = RxView.draws(this).map { Unit }
 ...
 */
fun View.globalLayouts(): Observable<Unit> = RxView.globalLayouts(this).map { Unit }
 ...
 */
fun View.hovers(): Observable<MotionEvent> = RxView.hovers(this)
 ...
 */
fun View.hovers(handled: Func1<in MotionEvent, Boolean>): Observable<MotionEvent> = RxView.hovers(this, handled)
 ...
 * to free this reference.
 */
fun View.layoutChanges(): Observable<Unit> = RxView.layoutChanges(this).map { Unit }
 ...
 * to free this reference.
 */
fun View.layoutChangeEvents(): Observable<ViewLayoutChangeEvent> = RxView.layoutChangeEvents(this)
 ...
 */
fun View.longClicks(): Observable<Unit> = RxView.longClicks(this).map { Unit }
 ...
 */
fun View.longClicks(handled: Func0<Boolean>): Observable<Unit> = RxView.longClicks(this, handled).map { Unit }
 ...
 */
fun View.preDraws(proceedDrawingPass: Func0<Boolean>): Observable<Unit> = RxView.preDraws(this, proceedDrawingPass).map { Unit }
 ...
 * to free this reference.
 */
fun View.scrollChangeEvents(): Observable<ViewScrollChangeEvent> = RxView.scrollChangeEvents(this)
 ...
 */
fun View.systemUiVisibilityChanges(): Observable<Int> = RxView.systemUiVisibilityChanges(this)
 ...
 * touches. Only one observable can be used for a view at a time.
 */
fun View.touches(): Observable<MotionEvent> = RxView.touches(this)
 ...
 */
fun View.touches(handled: Func1<in MotionEvent, Boolean>): Observable<MotionEvent> = RxView.touches(this, handled)
 ...
 * to free this reference.
 */
fun View.activated(): Action1<in Boolean> = RxView.activated(this)
 ...
 * to free this reference.
 */
fun View.clickable(): Action1<in Boolean> = RxView.clickable(this)
 ...
 * to free this reference.
 */
fun View.enabled(): Action1<in Boolean> = RxView.enabled(this)
 ...
 * to free this reference.
 */
fun View.pressed(): Action1<in Boolean> = RxView.pressed(this)
 ...
 * to free this reference.
 */
fun View.selected(): Action1<in Boolean> = RxView.selected(this)
 ...
 * to free this reference.
 */
fun View.visibility(): Action1<in Boolean> = RxView.visibility(this)
 ...
 * or `View.GONE`).
 */
fun View.visibility(visibilityWhenFalse: Int): Action1<in Boolean> = RxView.visibility(this, visibilityWhenFalse)
