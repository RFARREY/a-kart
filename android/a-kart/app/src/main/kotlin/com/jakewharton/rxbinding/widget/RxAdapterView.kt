 ...
 */
fun <T : Adapter> AdapterView<T>.itemLongClicks(handled: Func0<Boolean>): Observable<Int> = RxAdapterView.itemLongClicks(this, handled)
 ...
 * underlying [AdapterView.OnItemLongClickListener].
 */
fun <T : Adapter> AdapterView<T>.itemLongClickEvents(handled: Func1<in AdapterViewItemLongClickEvent, Boolean>): Observable<AdapterViewItemLongClickEvent> = RxAdapterView.itemLongClickEvents(this, handled)
 ...
 * to free this reference.
 */
fun <T : Adapter> AdapterView<T>.selection(): Action1<in Int> = RxAdapterView.selection(this)
