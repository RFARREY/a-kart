 ...
 */
fun AutoCompleteTextView.itemClickEvents(): Observable<AdapterViewItemClickEvent> = RxAutoCompleteTextView.itemClickEvents(this)
 ...
 * to free this reference.
 */
fun AutoCompleteTextView.completionHint(): Action1<in CharSequence> = RxAutoCompleteTextView.completionHint(this)
 ...
 * to free this reference.
 */
fun AutoCompleteTextView.threshold(): Action1<in Int> = RxAutoCompleteTextView.threshold(this)
