 ...
 */
fun Toolbar.itemClicks(): Observable<MenuItem> = RxToolbar.itemClicks(this)
 ...
 */
fun Toolbar.navigationClicks(): Observable<Unit> = RxToolbar.navigationClicks(this).map { Unit }
